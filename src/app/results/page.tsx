...
const RejectedScreen = () => (
    <div>
        ...
        <h2 className="text-5xl font-bold text-[#FF3E14] mb-6 font-poppins">
            You Didn't Qualify — Yet
        </h2>
        <p className="text-2xl font-poppins text-white/90 mb-4">
            Thanks for taking the quiz. Based on your answers, you're not quite ready for Next Level Coach AI.
        </p>
        <p className="text-xl font-poppins text-white/80 mb-6">
...
const QualifiedScreen = () => (
    <div>
        ...
        <h2 className="text-5xl font-bold text-white mb-2 font-poppins">
            You Qualify
        </h2>
        <h2 className="text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-fuchsia-500 to-purple-600 mb-6 font-poppins">
        ...
        <p className="text-lg text-purple-400 mb-8 font-poppins">Let's make it count!</p>

        <div className="bg-transparent border-qualified p-1 rounded-2xl mb-8">
            <div className="bg-black/40 rounded-xl px-8 py-6">
                <h3 className="text-2xl font-bold mb-2 font-poppins text-white">AI‑Ready Coach</h3>
        ...
        <button className="bg-gradient-to-t from-fuchsia-200 via-fuchsia-600 to-purple-700 hover:from-fuchsia-300 hover:via-fuchsia-700 hover:to-purple-800 cursor-pointer text-white font-bold py-3 px-12 rounded-lg text-xl transition-all duration-300 transform hover:scale-105 font-poppins">
